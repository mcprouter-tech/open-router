"""
Configuration utilities for Contextus
"""
...
DEFAULT_CONFIG_DIR = os.path.expanduser("~/.config/contextus")
DEFAULT_CONFIG_FILE = os.path.join(DEFAULT_CONFIG_DIR, "config.json")
# default router config
DEFAULT_HOST = "localhost"
DEFAULT_PORT = 6276  # 6276 represents Contextus on a T9 keypad (6=M, 2=C, 7=P, 6=M)
# default splitor pattern
TOOL_SPLITOR = "_t_"
RESOURCE_SPLITOR = ":"
RESOURCE_TEMPLATE_SPLITOR = ":"
PROMPT_SPLITOR = "_p_"
DEFAULT_SHARE_ADDRESS = f"share.contextus.sh:{DEFAULT_PORT}"
CONTEXTUS_AUTH_HEADER = "X-Contextus-SECRET"
CONTEXTUS_PROFILE_HEADER = "X-Contextus-PROFILE"
