"""
Repository utilities for Contextus - handles server discovery and installation
"""
...
from contextus.utils.config import DEFAULT_CONFIG_DIR

logger = logging.getLogger(__name__)

# Default repository URL
DEFAULT_REPO_URL = "https://contextus.sh/api/servers.json"
