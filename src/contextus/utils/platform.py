"""
Platform-specific utilities for Contextus router.
...
def get_log_directory(app_name: str = "contextus") -> Path:
    """
...
def get_pid_directory(app_name: str = "contextus") -> Path:
    """
...
def get_frpc_directory(app_name: str = "contextus") -> Path:
    """
