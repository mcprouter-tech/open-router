...
from contextus.core.schema import RemoteServerConfig, ServerConfig
from contextus.utils.scope import CLIENT_PREFIX, PROFILE_PREFIX
...
def print_no_active_scope():
    ...
    console.print("Please set an active target with 'contextus target set @<client>' or 'contextus target set %<profile>'.")
