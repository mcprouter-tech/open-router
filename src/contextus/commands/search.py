"""
Search command for Contextus - Search and display available MCP servers from the registry
"""

import click
from rich.console import Console

from contextus.utils.display import print_error, print_servers_table, print_simple_servers_list
...
def search(query, table=False):
    ...
    \b
        contextus search                  # List all available servers (names only)
        contextus search github           # Search for github server
        contextus search --table          # Show results in a table with descriptions
    """
