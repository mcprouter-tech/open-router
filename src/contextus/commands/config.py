"""Config command for Contextus - Manage Contextus configuration"""
...
def config():
    """Manage Contextus configuration.

    Commands for managing Contextus configuration and cache.
    """
    pass
...
def clear_cache():
    ...
    Examples:
        contextus config clear-cache    # Clear the local repository cache
    """
    try:
