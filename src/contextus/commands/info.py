"""
Info command for Contextus - Show detailed information about a specific MCP server
"""

import click
from rich.console import Console

from contextus.utils.display import print_error
...
def info(server_name):
    ...
    \b
        contextus info github            # Show details for the GitHub server
        contextus info pinecone          # Show details for the Pinecone server
    """
