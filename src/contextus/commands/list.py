...
from contextus.commands.target_operations.common import determine_scope
from contextus.core.schema import ServerConfig
from contextus.profile.profile_config import ProfileConfigManager
from contextus.utils.display import print_client_error, print_server_config
...
def list(target: str | None = None):
    ...
    if scope_type == ScopeType.CLIENT:
        ...
        if not servers and not stashed_servers:
            ...
            console.print("Use 'contextus add <server>' to add a server.")
            return
