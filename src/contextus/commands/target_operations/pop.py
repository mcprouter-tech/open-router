"""Pop command for Contextus - restores previously stashed server configuration"""
...
from contextus.commands.target_operations.common import determine_target
from contextus.core.schema import ServerConfig
from contextus.profile.profile_config import ProfileConfigManager
from contextus.utils.scope import ScopeType, format_scope
...
def pop(server_name):
    ...
    \b
        contextus pop memory
        contextus pop %profile/memory
    """
    ...
    if scope_type == ScopeType.CLIENT:
        ...
        if client_manager is None:
            ...
            console.print("Please switch to a supported client using 'contextus client set <client-name>'")
            return
