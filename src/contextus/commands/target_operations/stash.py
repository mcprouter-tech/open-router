"""Stash command for Contextus - temporarily stores server configuration aside"""
...
def stash(server_name):
    ...
    \b
        contextus stash memory
        contextus stash @cursor/memory
        contextus stash %profile/memory
    """
    ...
    if stash_success:
        ...
        if remove_success:
            ...
            console.print("Server configuration is stored and can be restored with 'contextus pop'.")
        else:
