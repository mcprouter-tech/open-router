...
from contextus.commands.target_operations.common import client_add_server, determine_scope, profile_add_server
from contextus.core.schema import RemoteServerConfig, STDIOServerConfig
from contextus.utils.display import print_server_config
from contextus.utils.scope import ScopeType
...
def stdio(server_name, command, args, env, target, force):
    ...
    \b
        contextus import stdio <server_name> --command <command> --args <arg1> --args <arg2> --env <var1>=<value1> --env <var2>=<value2>
    """
...
def remote(server_name, url, header, target, force):
    ...
    \b
        contextus import remote <server_name> --url <url> --header <key1>=<value1> --header <key2>=<value2>
    """
    scope_type, scope = determine_scope(target)
    if not scope:
        return
