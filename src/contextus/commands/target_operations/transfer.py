...
from contextus.utils.display import print_active_scope, print_no_active_scope
from contextus.utils.scope import ScopeType, extract_from_scope
...
def copy(source, destination, force=False):
    ...
    \b
        contextus cp memory memory2
        contextus cp @cursor/memory @windsurf/memory
    """
    (
        source_context_type,
        source_context,
...
def move(source, destination, force=False):
    ...
    \b
        contextus mv memory memory2
        contextus mv @cursor/memory @windsurf/memory
    """
    (
        source_context_type,
        source_context,
