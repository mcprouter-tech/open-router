...
from contextus.utils.display import print_client_error, print_error, print_server_config
...
def client():
    ...
    \b
        contextus client ls              # List all supported MCP clients and their status
        contextus client edit            # Open active client MCP settings in external editor
    """
    pass
